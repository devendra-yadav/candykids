		...
		<table class="beautiful">
			...
			<c:forEach items="${allItems}" var="item">
				<tr>
					...
					<td>
						<a href="${pageContext.request.contextPath}/items/formEditItem?itemId=${item.itemId}"><input type="button" value="Edit"></a>
						<a href="${pageContext.request.contextPath}/items/deleteItem?itemId=${item.itemId}" title="Delete Item" onclick="return confirm('Are you sure you want to delete item with item id -->${item.itemId}<--')"><input type="button" value="Delete"></a>
					</td>
				</tr>
			</c:forEach>
