...
<title>Candy Kids. Add New Item</title>
...
<body class="body-color">
	...
	<div align="center">
		...
		<form:form method="POST" action="${pageContext.request.contextPath}/items/addItem" modelAttribute="item" enctype="multipart/form-data">
			<table>
				<tr>
					<td>Title</td>
